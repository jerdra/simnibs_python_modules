...
import simnibs.utils.version as version
...
if __name__ == '__main__':
    ...
    msh = gmsh.read_msh(os.path.abspath(os.path.realpath(os.path.expanduser(args.mesh))))
    ...
    for ed in msh.elmdata:
        ...
        f = ed.interpolate_scattered(points, out_fill=args.out_fill,
                                     method=args.method, continuous=c,
                                     squeeze=False)
        if f.ndim == 1:
            f = f[:, None]
