...
class TestDrawElectrodes:
    ...
    def test_build_electrode(self):
        ...
        mesh = gmsh.Msh()
        mesh.elm = gmsh.Elements(#triangles=triangles+1)
                                 tetrahedra=tetrahedra + 1)
        mesh.nodes = gmsh.Nodes(new_points)
        #gmsh.write_msh(mesh, '~/Tests/electrode.msh')
    ...
    def test_build_electrode_on_mesh(self):
        ...
        mesh = gmsh.Msh()
        mesh.elm = gmsh.Elements(triangles=tri.simplices+1)
        mesh.nodes = gmsh.Nodes(nodes)
        w_elec = electrode_placement._build_electrode_on_mesh(c, ydir, poly, h, mesh, el_vol_tag=2,
                                                              el_surf_tag=1002, on_top_of=1)

        #gmsh.write_msh(w_elec, '~/Tests/electrode.msh')
    ...
    def test_mesh_electrode(self):
        ...
        #gmsh.write_msh(w_elec, '~/Tests/electrode1.msh')
        vols = w_elec.elements_volumes_and_areas().value
        ...
        #gmsh.write_msh(w_elec, '~/Tests/electrode2.msh')
        vols = w_elec.elements_volumes_and_areas().value
        ...
        #gmsh.write_msh(w_elec, '~/Tests/electrode3.msh')
        vols = w_elec.elements_volumes_and_areas().value
        ...
        vols = w_elec.elements_volumes_and_areas().value
        #gmsh.write_msh(w_elec, '~/Tests/electrode4.msh')
        ...
        #gmsh.write_msh(w_elec, '~/Tests/electrode5.msh')
        vols = w_elec.elements_volumes_and_areas().value
        ...
        #gmsh.write_msh(w_elec, '~/Tests/electrode6.msh')
        vols = w_elec.elements_volumes_and_areas().value
